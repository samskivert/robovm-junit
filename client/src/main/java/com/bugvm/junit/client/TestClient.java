...
package com.bugvm.junit.client;
...
import com.bugvm.compiler.plugin.PluginArguments;
...
import com.bugvm.junit.protocol.Command;
import com.bugvm.junit.protocol.ResultObject;
import com.bugvm.junit.protocol.ResultType;
import com.bugvm.libimobiledevice.IDevice;
import com.bugvm.libimobiledevice.IDeviceConnection;
...
public class TestClient extends LaunchPlugin {
    ...
    public static final String SERVER_WRAPPER_CLASS_NAME = "com.bugvm.objc.NonUICodeWrapper";
    public static final String SERVER_CLASS_NAME = "com.bugvm.junit.server.TestServer";
    ...
    public void beforeLaunch(Config config, LaunchParameters parameters) {
         ...
         */
        parameters.getArguments().add("-rvm:Dbugvm.launchedFromTestClient=true");
        ...
        if (config.getOs() == OS.ios) {
            ...
            env.put("bugvm.wrappedClass", mainClassName);
    ...
    public Config.Builder configure(Config.Builder configBuilder, boolean isIOS) {
        if (configBuilder == null) {
            throw new IllegalArgumentException("BugVM configuration cannot be null");
        }

        configBuilder.addForceLinkClass("com.bugvm.junit.server.TestServer");
        if (isIOS) {
