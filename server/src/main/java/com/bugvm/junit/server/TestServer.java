 ...
 */
package com.bugvm.junit.server;
 ...
 * the testee (console, simulator, device). This code runs inside BugVM and
 * will be bundled with the test classes into an executable.
 */
public class TestServer {
    public static final String DEBUG = "bugvm.debug";

    private static BugTestListener listener;
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (System.getProperty("os.name").equals("iOS Simulator") 
                && !Boolean.getBoolean("bugvm.launchedFromTestClient")) {
            return;
        }
        ...
        return Observable.create(new Observable.OnSubscribe<String>() {
            ...
            public void call(Subscriber<? super String> subscriber) {
                try {
                    ...
                    listener = new BugTestListener(out);
